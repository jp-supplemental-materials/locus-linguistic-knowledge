...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep  3 12:11:03 2026
...
def objective(exemplar_val, exemplar_form, exemplar_cat, clouds):
    #Step 1: Calculate the penalties for the current exemplar
    preN_bias_pen = preN_nasality_bias(exemplar_val[0], exemplar_cat, clouds)
    
    return (preN_bias_pen)
...
#exemplar_trials.to_csv("model5-100SIMS.csv", index = False)
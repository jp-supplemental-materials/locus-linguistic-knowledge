...
# -*- coding: utf-8 -*-
"""
Created on Wed Sep  9 14:48:55 2026
...
def exemplar_accumulation(clouds, num_exemplars):
    ...
    for i in range(num_exemplars):
        ...
        #introducing high-nasality examplars after 300 iterations
...
exemplar_trials.to_csv("model5-1-100SIMS.csv", index = False)